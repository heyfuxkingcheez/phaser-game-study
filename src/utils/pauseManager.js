...
document.addEventListener('keydown', (e) => {
    if (
        ((type_pause === 'pause' && e.key === 'Escape') ||
            (type_pause === 'levelup' && e.key === 'Enter')) &&
        ...
        // 레벨업으로 인한 일시정지였을 경우, pause 해제 후 PlayingScene의 afterLevelUp 함수를 실행
...
// scene이 반투명 검은 veil 화면을 만들어주는 함수
